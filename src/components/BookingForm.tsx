      ...
      <div className="mx-auto block max-w-[1400px] items-start gap-16 lg:grid lg:grid-cols-12">
        <div className="reveal-up mb-12 lg:col-span-5 lg:mb-0">
          <h2 className="mb-8 font-heading text-5xl leading-[0.9] font-bold tracking-tighter text-anthracite uppercase md:text-7xl">
            Foglald le <br />a <span className="text-gold">széked.</span>
          </h2>
          <p className="mb-8 max-w-md font-body text-lg text-darkgray/70">
            Ne várj a sorodra. Biztosítsd be az időpontod előre. Töltsd ki az adataidat, és a
            megadott számon felvesszük veled a kapcsolatot a pontosítás végett.
          </p>
